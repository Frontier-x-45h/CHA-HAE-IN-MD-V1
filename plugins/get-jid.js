...
cmd({
    ...
    try {
        ...
        if (!isGroup && !isOwner) {
            return reply("⚠️ 🤦🏻‍♀️Baka Only the bot owner or group admins can use this command.");
        }
...
cmd({
    ...
    try {
        ...
        if (!isGroup && !isOwner) {
            return reply("⚠️ Baka 🤦🏻‍♀️Only the bot owner or group admins can use this command.");
        }
