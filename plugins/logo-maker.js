...
cmd({
  ...
  try {
    ...
    let responseText = `*🤍 CHA HAE-IN-MD LOGO MAKER 💅*\n\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n`
    + `*◈ Text:* ${q}\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n\n`
    ...
    conn.ev.on('messages.upsert', async (event) => {
      ...
      if (receivedMessage.message.extendedTextMessage.contextInfo && 
        ...
        if (logoUrls[receivedText]) {
          ...
          await conn.sendMessage(from, { image: { url: response.result.download_url }, caption: "> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ The Frontier*" }, { quoted });
        } else {
