...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data.message }, caption: '> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Frontier-x-45h ' }, { quoted: mek });
    } catch (e) {
        console.log(e); // ❯❯ Powered by Frontier the goat 👑
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data[0].url }, caption: 'CHA HAE-IN-MD DOWNLOAD CAT 🐈 PICS\n\n> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ the Frontier*' }, { quoted: mek });
    } catch (e) {
        console.log(e);
