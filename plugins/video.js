...
cmd({
  ...
  try {
    ...
    _0x2710af("```_© CHA HAE-IN-MD Gᴇɴᴇʀᴀᴛɪɴɢ Vɪᴅᴇᴏ Pʟᴇᴀsᴇ Wᴀɪᴛ..._```");
...
cmd({
  ...
  try {
    ...
    if (!_0x2b4b83) {
      return _0x31fd3f("*Please Malvin an audio title or url*");
    }
    _0x31fd3f("```© _CHAHAEIN_ Gᴇɴᴇʀᴀᴛɪɴɢ Sᴏɴɢ Pʟᴇᴀs Wᴀɪᴛ...```");
