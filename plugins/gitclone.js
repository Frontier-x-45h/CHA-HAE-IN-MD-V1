...
cmd({
  ...
  if (!args[0]) {
    return reply("❌ Where is the GitHub link?\n\nExample:\n.gitclone https://github.com/Frontier-x-45h/CHA-HAE-IN-MD-V1");
  }

  if (!/^(https:\/\/)?github\.com\/.+/.test(args[0])) {
    return reply("⚠️ 🤦🏻‍♀️Baka Invalid GitHub link. Please provide a valid GitHub repository URL.");
  }
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: 'CHA HAE-IN-MD ɢɪᴛʜᴜʙ ᴄʟᴏɴᴇ🧕',
          serverMessageId: 143
        }
      }
    }, { quoted: m });
