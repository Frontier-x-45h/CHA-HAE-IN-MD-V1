...
if (!isAdmins) return reply(ADMIN)	
  if (args[1] == 'second') {
                ...
                setTimeout(() => {
                    ...
                    const open = `OPEN TIME THE GROUP WAS OPENED BY CHA HAE-IN-MD TO APPROVED ADMIN\n NOW MEMBERS CAN SEND MESSAGES 🔓`
...
if (!isAdmins) return reply(ADMIN)	
                ...
                setTimeout(() => {
                    ...
                    const close = `CLOSE TIME GROUP CLOSED BY CHA HAE-IN-MD AT APPROVED ADMIN\nNOW ONLY ADMIN CAN SEND MESSAGES 🔐`
...
try{
        ...
        let adminTagMessage = '*SUMMONING ALL ADMINS IN THE GROUP 🔳:*\n\n';
