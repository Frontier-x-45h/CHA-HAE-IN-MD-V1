...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("*Example -* .pair +263714757XXX");
        }

        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://chahaein-pair-code-xzcb.onrender.com/code?phone=${q}`);
        ...
        const doneMessage = "> *CHA HAE-IN-MD PAIR COMPLETED*";
...
/* CHA HAE-IN-MD Coded by The Frontier
